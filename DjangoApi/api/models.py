...
class Airports(models.Model):
    ...
    def get_name_iata(self):
        return (self.name,self.iata)


class Bookings(models.Model):
    id = models.BigAutoField(primary_key=True)
    flight_from = models.ForeignKey('Flights', models.DO_NOTHING, db_column='flight_from', related_name = 'flight_from')
    flight_back = models.ForeignKey('Flights', models.DO_NOTHING, db_column='flight_back', blank=True, null=True)
...
class Flights(models.Model):
    ...
    from_field = models.ForeignKey(Airports, models.DO_NOTHING, db_column='from_id',related_name = 'from_id')  # Field renamed because it was a Python reserved word.
    to = models.ForeignKey(Airports, models.DO_NOTHING)
